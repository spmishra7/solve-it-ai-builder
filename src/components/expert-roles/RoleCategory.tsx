    ...
    <div key={category.id} className="border rounded-lg overflow-hidden shadow-sm">
      ...
      >
        <div className="flex items-center">
          ...
          <span className={`font-medium ${isExpanded ? "text-brand-800" : ""}`}>{category.name}</span>
        </div>
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xs bg-muted text-muted-foreground px-2 py-1 rounded hidden sm:inline-block">
