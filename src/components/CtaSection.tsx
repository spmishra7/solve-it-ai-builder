  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto bg-gradient-to-r from-brand-600 to-teal-600 rounded-xl overflow-hidden shadow-xl">
          <div className="px-6 py-12 md:p-12 text-white text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button className="bg-white text-brand-600 hover:bg-gray-100 hover:text-brand-700 text-lg py-6 px-8">
                Get Started Free
              </Button>
